 ...
 *
 * <p>This class uses the OAuth 2.0 client credentials flow with authorization details
 * to request tokens scoped to specific Unity Catalog resources. The generated tokens
 * include privileges for catalog, schema, and table access required for ingestion.
 */
public class TokenFactory {
     ...
     * <ul>
     *   <li>USE CATALOG on the table's catalog</li>
     *   <li>USE SCHEMA on the table's schema</li>
     *   <li>SELECT and MODIFY on the target table</li>
     * </ul>
     *
    ...
    public static String getZerobusToken(
            ...
            String workspaceUrl,
            String clientId,
            String clientSecret) throws NonRetriableException {
        ...
        String authorizationDetails = String.format(
                "[\n" +
                "  {\n" +
                ...
                catalogName, schemaName, tableNameOnly);
        ...
        try {
            ...
            String formData = "grant_type=client_credentials" +
                    ...
                    "&authorization_details=" + URLEncoder.encode(authorizationDetails, "UTF-8");
